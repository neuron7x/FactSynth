...
"""Endpoints exposing interactive symbolic reasoning simulations."""
...
class SimRequest(BaseModel):
    """Parameters controlling ISR simulation."""
...
def simulate(req: SimRequest) -> Dict[str, Any]:
    """Run the ISR simulation and return time series."""
...
class SpectrumRequest(BaseModel):
    """Request payload for spectrum analysis."""
...
def spectrum(req: SpectrumRequest) -> Dict[str, Any]:
    """Compute gamma-band spectrum and dominant frequency."""
